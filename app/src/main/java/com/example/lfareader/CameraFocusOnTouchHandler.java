...
public class CameraFocusOnTouchHandler implements View.OnTouchListener{
    ...
    //    public CameraFocusOnTouchHandler(CameraCharacteristics characteristics, CaptureRequest.Builder mCaptureRequestBuilder, CameraCaptureSession mCameraCaptureSession, Handler mHandler) {
//    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (isMeteringAreaAWBSupported()){
            mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AWB_REGIONS, new MeteringRectangle[]{focusAreaTouch});
        }
        Log.d(TAG, "onTouch: camera settings");
...
//        mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AWB_MODE,CameraMetadata.CONTROL_AWB_MODE_AUTO);
    ...
    private boolean isMeteringAreaAESupported() {
        Integer value = mCameraCharacteristics.get(CameraCharacteristics.CONTROL_MAX_REGIONS_AE);
        if (value != null) {
            return value >= 1;
        } else {
            return false;
    ...
    private boolean isMeteringAreaAWBSupported() {
        Integer value = mCameraCharacteristics.get(CameraCharacteristics.CONTROL_MAX_REGIONS_AWB);
        if (value != null) {
            return value >= 1;
        } else {
            return false;
